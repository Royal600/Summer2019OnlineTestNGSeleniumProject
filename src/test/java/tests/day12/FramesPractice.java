...
public class FramesPractice {
    ...
    public void test1(){
       ...
       // since element inside a frame, element is not visible for selenium
        ...
        //we can switch to frame based on id, name, index(starting from 0), web elememt
    ...
    public void test2(){
        ...
        // it is because content that is inside a frame is not visible for selenium
