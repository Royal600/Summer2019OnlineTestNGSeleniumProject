...
public class ActionsClassHoverPractice {
    ...
    @Test(description = "Verify first image")
     public void test1(){
// create object of creations class to perform actions (drag and drop, contect click, move to specific point  and etc)
        ...
        //moveToElement = hover
        //.perform() s/tands for triggering actions
        action.moveToElement(image1).perform();
        //h5 is grand child  of  .figure:nth-of-type(1) this element that contains image
