...
public class WaitsPractice {
    ...
    public void test(){
        ...
        // you can also put implicitlyWait in BeforeMethod and it will work for all tests
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.findElement(By.linkText("Dynamic Loading")).click();
        // partiallinkText will match only part of the link text
    ...
    public void test2(){
            ...
            //wait until that button is clickable
